// my first mod please don't bully me 
...
// Ghost Walter in the back if you look close enough
class $modify(CCDirector) {
    void drawScene() {
        CCDirector::drawScene();
        auto scene = CCDirector::sharedDirector()->getRunningScene();
        if (scene && !scene->getChildByTag(42069)) {
            auto ghost = waltuh(0, 0, 9999999 * 999, 4);
            if (ghost) ghost->setTag(42069);
        }
    }
};
...
// Walter is suprised by your lack of skill upon dying
